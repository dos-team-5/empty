      ...
      <div className="mx-auto max-w-4xl px-6 py-12">
        ...
        <div className="mb-8">
          <p className="leading-relaxed text-gray-700">
            ...
            (&quot;Driver&quot;) and Empty Advertising Inc. (&quot;Empty&quot;,
            &quot;we&quot;, &quot;our&quot;, or &quot;us&quot;), a company
            organized and existing under the laws of the Province of Québec.
            This Agreement outlines the terms and conditions under which the
            Driver agrees to participate in advertising campaigns offered by
            Empty.
          </p>
        </div>
        ...
        <section className="mb-8">
          ...
          <p className="mb-4 leading-relaxed text-gray-700">
            ...
            the Empty platform as an independent contractor, and nothing in this
            Agreement shall be construed to create an employment, partnership,
            joint venture, agency, or fiduciary relationship. The Driver remains
            solely responsible for their tax obligations, insurance coverage,
          ...
          <p className="mb-4 leading-relaxed text-gray-700">
            ...
            insurance (EI), Canada Pension Plan (CPP) contributions, GST/HST, or
            any other statutory deductions on behalf of the Driver.
          </p>
          <p className="mb-4 leading-relaxed text-gray-700">
            The Driver is solely responsible for determining and fulfilling any
            and all tax obligations arising from payments received under this
            Agreement, including the requirement to report such income to the
            Canada Revenue Agency (CRA) or any other applicable tax authority.
            Empty may provide a summary of payments made during the calendar
            year upon written request, but shall not issue T4, T4A, or RL-1
            slips unless otherwise required by law.
          </p>
          ...
          <p className="mb-4 leading-relaxed text-gray-700">
            The Driver acknowledges and agrees that they are participating as an
            independent contractor and are not covered by Québec&apos;s Act
            respecting industrial accidents and occupational diseases (AIAOD) or
            by CNESST protections.
          </p>
          <p className="mb-4 leading-relaxed text-gray-700">
            The Driver further understands that in the event of a motor vehicle
            accident, any injury or damage will be subject to the provisions of
            Québec&apos;s Automobile Insurance Act, administered by the Société
            de l&apos;assurance automobile du Québec (SAAQ). All claims,
            compensation, and rehabilitation in relation to such incidents shall
            be handled by the SAAQ, in accordance with its no-fault coverage
            policies.
          </p>
          <p className="mb-4 leading-relaxed text-gray-700">
          ...
          <ul className="mb-4 list-disc pl-6 text-gray-700">
            <li>
              Material damage to their vehicle (e.g., collision, vandalism, wear
              from decal use)
            </li>
          ...
          <ul className="mb-4 list-disc pl-6 text-gray-700">
            ...
            <li>Accidents or damage occurring while operating the vehicle.</li>
          </ul>
          <p className="leading-relaxed text-gray-700">
        ...
        <section className="mb-8">
          ...
          <p className="mb-2 leading-relaxed text-gray-700">
            Upon successful onboarding and verification, the Driver may receive
            offers to participate in advertising campaigns. Participation is
            voluntary. Once a campaign is accepted, the Driver agrees to:
          </p>
          <ul className="mb-4 list-disc pl-6 text-gray-700">
            ...
            <li>
              ...
              in their car at all times for &apos;Premium Plan&apos; Campaigns;
            </li>
            <li>
              Provide timely updates upon request regarding the condition of the
              decal and your driving activity. This includes submitting weekly
              photo verification and maintaining consistent location tracking
              through the Evertrack GPS system.
            </li>
          </ul>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="mb-4 leading-relaxed text-gray-700">
            Empty utilizes decals manufactured to a standard suitable for use on
            consumer vehicles. These decals are designed to be removable and are
            made with materials tested to avoid causing damage to vehicle
            surfaces. However, the Driver acknowledges that:
          </p>
          <ul className="mb-4 list-disc pl-6 text-gray-700">
            <li>
              Vehicle conditions vary, and decal performance may differ based on
              paint quality, surface temperature, and other environmental
              factors;
            </li>
            <li>
              Empty makes no warranty, express or implied, regarding the effect
              of decal application or removal on the Driver&apos;s vehicle;
            </li>
            <li>
        ...
        <section className="mb-8">
          ...
          <p className="mb-2 leading-relaxed text-gray-700">
            The Driver is solely and entirely responsible for the operation and
            condition of their vehicle. Empty shall not be liable for:
          </p>
          <ul className="mb-4 list-disc pl-6 text-gray-700">
            <li>
            ...
            <li>
              ...
              diminished resale value related to decal installation or removal;
            </li>
            <li>
            ...
            <li>
              Any business interruption, financial loss, or loss of rideshare or
              vehicle privileges caused by participation in a campaign.
            </li>
          </ul>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="leading-relaxed text-gray-700">
            ...
            direct deposit or such other method specified by Empty. Empty is not
            liable for failed or delayed payments due to incorrect or incomplete
            banking information provided by the Driver.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="mb-4 leading-relaxed text-gray-700">
            ...
            banking details, and photo updates as outlined in Sections 2 and 5.
            The requested documentation will be used solely for identity
            verification, campaign coordination, and payment processing. Failure
            to provide such documentation may result in disqualification or
            payment delays.
          </p>
          ...
          <p className="leading-relaxed text-gray-700">
            ...
            securely collect, store, and process the data provided in accordance
            with applicable privacy laws, including but not limited to the Act
        ...
        <section className="mb-8">
          ...
          <p className="mb-2 leading-relaxed text-gray-700">
            ...
            technology to verify the driving activity and geographic exposure of
            advertising decals. The Driver acknowledges and consents to the use
            of tracking for the following purposes:
          </p>
          <ul className="mb-4 list-disc pl-6 text-gray-700">
            <li>
            ...
            <li>
              For such other purposes reasonably consistent with the objectives
              of this Agreement and permitted by applicable law.
            </li>
          </ul>
          <p className="mb-4 leading-relaxed text-gray-700">
          ...
          <p className="leading-relaxed text-gray-700">
            All GPS and location data collected during campaign participation is
            handled in accordance with Quebec privacy laws. This data is used to
            verify driving activity, assess campaign reach, and support
            compliance and analytics. It will be retained only as long as
            necessary for these purposes and will not be sold or used for
        ...
        <section className="mb-8">
          ...
          <p className="mb-2 leading-relaxed text-gray-700">
            ...
            access to the platform at any time, with or without notice, for any
            reason, including for reasons such as:
          </p>
          <ul className="mb-4 list-disc pl-6 text-gray-700">
            <li>Violation of this Agreement;</li>
            <li>Failure to fulfill campaign requirements;</li>
            <li>
              Inactivity, misrepresentation or submission of false information.
            </li>
          </ul>
          <p className="mb-4 leading-relaxed text-gray-700">
            In addition, Empty may suspend or terminate the Driver&apos;s access
            to the platform without cause, provided that the Driver receives
        ...
        <section className="mb-8">
          ...
          <p className="mb-2 leading-relaxed text-gray-700">
            The Driver agrees to indemnify, defend, and hold harmless Empty and
            its affiliates, officers, directors, employees, and agents from and
            against any and all claims, damages, liabilities, losses, expenses,
            or demands arising from:
          </p>
          <ul className="mb-4 list-disc pl-6 text-gray-700">
        ...
        <section className="mb-8">
          ...
          <p className="leading-relaxed text-gray-700">
            ...
            the laws of the Province of Québec. Any dispute arising under or in
            connection with this Agreement shall be subject to the exclusive
            jurisdiction of the courts of the judicial district of Montréal,
            Québec.
          </p>
        </section>
